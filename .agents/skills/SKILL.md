...
| Template | Best For | Roles | Key Features |
|----------|----------|-------|--------------|
| **uiux-audit-team** | UX/UI Auditing on Figma links | LA, UXE, EC, UIA, UXW | Figma MCP ready, UX writing review, Edge Case hunting, WCAG |
...
- "audit" / "review Figma" / "check UIUX" / "Figma link" → Use `uiux-audit-team`
...
**Design & Audit:**
- **uiux-audit-team** - UX/UI auditing with LA, UXE, EC, UIA, UXW. Specialized in Figma review, Edge cases, and UX writing.
...
#### 5. uiux-audit-team (UX/UI Design Audit)

**Roles:** LA (Lead Auditor), UXE (UX Examiner), EC (Edge Case Engineer), UIA (UI Auditor), UXW (UX Writer)

**Key Features:**
- Direct Figma MCP Integration for automated reading
- Dual frameworks: JTBD + Design Thinking
- UX writing review for microcopy optimization
- Edge Case testing for robust design

**Workflow:**
1. Scope Audit (LA)
2. Analyze Cognitive flows (UXE)
3. Discover missing Edge Cases (EC)
4. Audit Visuals & WCAG (UIA)
5. Refine Microcopy (UXW)
6. Synthesize Final Report (LA)

**Best for:** Quality assurance of Figma designs prior to delivery, UX auditing, identifying usability and copy flaws
