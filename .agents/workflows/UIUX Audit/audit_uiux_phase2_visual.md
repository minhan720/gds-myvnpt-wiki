---
description: Đánh giá Giao diện Visual, WCAG & Copywriting (Phase 2/2)
---

# UI/UX Audit Phase 2: Visual & Heuristic Workflow

**Vai trò thực hiện:** UI Visual Auditor
...
4. **Báo cáo Lỗi Visual:** Xuất bản danh sách `ui_findings.md` với gán Severity từ 🔴/🟠. 
5. **🛑 CHỜ PHÊ DUYỆT (HITL 2):** Khóa hệ thống. Nộp thư mục soi lỗi cho Boss ngắm lại. Đợi có `Approved` mới qua bước 3 (Kết màn).
