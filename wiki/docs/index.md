...
<div class="hero">
  ...
  <div class="actions">
    <a href="knowledge base/" class="md-button md-button--primary">Khám phá Knowledge Base</a>
    <a href="#onboarding" class="md-button">Xem Hướng Dẫn</a>
  </div>
</div>
...
<div class="features-grid">
  <div class="feature-card">
    ...
    <p>Thay đổi vai trò tuần tự để giải quyết nghiệp vụ từ nghiên cứu thị trường, xác định vấn đề, viết docs,... đến audit UI/UX mà không cần mở tab mới.</p>
  </div>
  <div class="feature-card">
    <div class="icon">⚡️</div>
    <h3>Đồng bộ thời gian thực</h3>
    <p>Mỗi khi tài liệu hoặc báo cáo được AI tạo mới trong Knowledge Base, trang Web sẽ lập tức được tự động cập nhật mà không cần cấu hình thêm.</p>
  </div>
  <div class="feature-card">
    <div class="icon">🔍</div>
    <h3>Quản trị tri thức (KB)</h3>
    <p>Hệ thống hoá kiến thức tự động thành dạng Web dễ đọc, dễ tra cứu mà không cần phải vào IDE.</p>
  </div>
</div>
...
Chào mừng bạn gia nhập dự án! Đây là một **Không gian làm việc kết hợp Trí tuệ Nhân tạo (Agentic AI Workspace)**, nơi bạn sẽ làm việc cùng trợ lý Antigravity được "trang bị vũ khí" là các quy trình làm việc chuyên nghiệp (Team Frameworks) để giải quyết bài toán từ nghiên cứu, thiết kế đến xây dựng tài liệu phục vụ cho việc phát triển phần mềm.
...
## 📁 4. Cấu Trúc Thư Mục Quan Trọng Cần Biết
