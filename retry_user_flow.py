...
def generate_mermaid_image_v2(code, output_file):
    # Use URL-safe and compact encoding
    payload = {
        "code": code,
        "mermaid": {"theme": "default"}
    }
    json_str = json.dumps(payload)
    # Using urlsafe base64
...
if __name__ == "__main__":
    path = 'c:/Users/caida/gds-myvnpt-wiki/User_Flow_Final_PNG.png'
    if generate_mermaid_image_v2(USER_FLOW_CODE, path):
